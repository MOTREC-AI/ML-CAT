#!/bin/bash
####################################################
# This script launches the runs for Test data sets containing data from only KS patients
...
val_name="${val_name}_full_ks_imputed_iterative.csv"
